...
public class EVStationsFragment extends Fragment {
    ...
    EVPointsAdapter EVPointsAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        options =
                new FirebaseRecyclerOptions.Builder<PumpsModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("ElectricPoints"), PumpsModel.class)
                        .build();
        EVPointsAdapter = new EVPointsAdapter(options);
        recview.setAdapter(EVPointsAdapter);
        EVPointsAdapter.notifyDataSetChanged();
//        recview.setNestedScrollingEnabled(false);
    ...
    public void onStart() {
        super.onStart();
        EVPointsAdapter.startListening();
    }

    @Override
    public void onStop() {
        super.onStop();
        EVPointsAdapter.stopListening();
    }
}